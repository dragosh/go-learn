...
//   we can compare values of this type with the == and != operators, this is required for map keys in Go
// V has the any constraint, meaning that it’s not restricted
//   in any way (any is an alias for interface{}).
...
* -----------------------------------------------------------
 */
//generic type List is a singly-linked list with values of any type.
